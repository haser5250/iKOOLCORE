...
**<small>本默认系统仅适用于：带硬盘配置的订单。<br>未选购硬盘配置订单，需要自行购买M.2插槽，2242尺寸，NVME协议的硬盘，自行按需安装系统。<br>1. OpenWRT固件推荐：[点此前往下载](https://u.iswott.com:8888/ISOs/) <br>2. iKuai固件：[点此前往下载](https://u.iswott.com:8888/ISOs/) <br>3. pfsense固件：[点此前往下载](https://u.iswott.com:8888/ISOs/) <br>4. OPNsense固件：[点此前往下载](https://u.iswott.com:8888/ISOs/) <br>5. Proxmox VE 固件：[点此前往下载](https://u.iswott.com:8888/ISOs/) <br>6. VMware ESXi固件[点此前往下载](https://u.iswott.com:8888/ISOs/) </small>** 
